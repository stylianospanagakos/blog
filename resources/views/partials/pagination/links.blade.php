@if ($paginator->hasPages())
    ...
    <ul class="pagination justify-content-center" role="navigation">
        ...
        @if ($paginator->onFirstPage())
            <li class="page-item disabled-extra-light" aria-disabled="true" aria-label="@lang('pagination.previous')">
        ...
        @else
            <li class="page-item disabled-extra-light" aria-disabled="true" aria-label="@lang('pagination.next')">
